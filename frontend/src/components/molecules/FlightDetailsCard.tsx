...
const FlightDetailsCard: React.FC<FlightDetailsCardProps> = ({
  ...
  const renderPrice = (offer: Offer) => {
    return (
      <div className="flex flex-col min-w-50 p-5 items-end justify-center border-l border-gray-200 text-start bg-gradient-to-br from-green-50 to-green-100 rounded-r-lg">
